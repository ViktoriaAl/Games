...
public class Board : MonoBehaviour
{
        ...
        else
        {
            for (int i = 0; i < SUPPORTED_KEYS.Length; i++)
            {
                if (Input.GetKeyDown(SUPPORTED_KEYS[i]))
                {
                    ...
                    currentRow.tiles[_columnIndex].SetState(occupiedState);
                    _columnIndex++;
                    break;
                }
            }
    ...
    private bool IsValiWord(string word)
    {
